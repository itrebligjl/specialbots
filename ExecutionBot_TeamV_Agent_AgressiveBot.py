...
class ExecutionBot(Management):
    ...
    def aggressive_slices_orders(self, qty, action, max_t, beta=0.8):
        ...
        try:
            ...
            # print("l1_size: {}, qty_target: {}, frac: {}".format(l1_size, qty_target, frac))
            if frac < beta:
    ...
    def twap_orders(self, qty, action, n_slices, exec_t=3.0):
        ...
        while i < n_slices:
            ...
            q = min(math.ceil(qty_target / n_slices) + qty_slice,
    ...
    def vwap_orders(self, qty, action, n_slices, exec_t=3.0):
        ...
        # print("sym:{}, start_time: {}, max_time: {}, time_slices: {}".format(sym, time_s, max_t, n_slices))
...
if __name__ == "__main__":
    ...
    myargparser.add_argument('--strategy', type=str, const="AggressiveWithSlice", nargs='?', default="AggressiveWithSlice")
    ...
    if strategy == 'AggressiveWithSlice':
        num__slices, pv, qty = exec_bot.aggressive_slices_orders(args.size, args.action, args.maxtime, beta=0.5)
    elif strategy == 'PoV':
